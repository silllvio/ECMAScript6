...
System.register(['../views/View', '../helpers/DateHelper', '../controllers/NegociacaoController'], function (_export, _context) {
    "use strict";
    ...
    return {
        setters: [function (_viewsView) {
            View = _viewsView.View;
