...
var NegociacaoController = function () {
    ...
    _createClass(NegociacaoController, [{
        ...
        value: function _init() {
            ...
            new NegociacaoService().findAll() // retorna todas as negociações.
            .then(function (negociacoes) {
                ...
                console.log(erro);
                _this._mensagem.texto = 'Erro na obtenção das listas';
            });
        ...
        value: function importaNegociacoes() {
            ...
            this._service.importa(this._listaNegociacoes.negociacoes) // Passa a lista atual de negociações.
            .then(function (negociacoes) {
                return negociacoes.forEach(function (negociacao) {
        ...
        value: function apaga() {
            ...
            this._service.delete().then(function (mensagem) {
